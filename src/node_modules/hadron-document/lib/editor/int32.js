...
var Int32Editor = /*#__PURE__*/function (_StandardEditor) {
  _inherits(Int32Editor, _StandardEditor);

  var _super = _createSuper(Int32Editor);
   ...
   */
  function Int32Editor(element) {
    _classCallCheck(this, Int32Editor);
