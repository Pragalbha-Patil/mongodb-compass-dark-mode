...
var ObjectIdEditor = /*#__PURE__*/function (_StandardEditor) {
  _inherits(ObjectIdEditor, _StandardEditor);

  var _super = _createSuper(ObjectIdEditor);
   ...
   */
  function ObjectIdEditor(element) {
    _classCallCheck(this, ObjectIdEditor);
