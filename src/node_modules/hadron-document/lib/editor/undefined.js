...
var UndefinedEditor = /*#__PURE__*/function (_StandardEditor) {
  _inherits(UndefinedEditor, _StandardEditor);

  var _super = _createSuper(UndefinedEditor);
   ...
   */
  function UndefinedEditor(element) {
    _classCallCheck(this, UndefinedEditor);
