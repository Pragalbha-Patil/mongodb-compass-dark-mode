...
var Int64Editor = /*#__PURE__*/function (_StandardEditor) {
  _inherits(Int64Editor, _StandardEditor);

  var _super = _createSuper(Int64Editor);
   ...
   */
  function Int64Editor(element) {
    _classCallCheck(this, Int64Editor);
